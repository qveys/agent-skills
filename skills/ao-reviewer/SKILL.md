...
6. Never run step 5 with an empty `githubReviewId`. If the GitHub post failed, keep the PR queued and report the error — even when the user already asked to send findings.
